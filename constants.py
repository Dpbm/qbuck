...
QUANTUM_FILES = (QUANTUM_DEFAULT_VERSION_FILE, QUANTUM_MODIFIED_VERSION_FILE)
ALL_FILES = (*CLASSICAL_FILES, *QUANTUM_FILES)
LABELS = ("classical-random", "classical-random-seed", "cpp-random-seed", "cpp", "quantum-regular", "quantum-modified")
